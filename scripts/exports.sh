...
# password1234_ - Note: Control ports are read from torrc files first, then these env vars as fallback
export APP_ELTOR_TOR_CONTROL_PASSWORD="password1234_"
...
# password1234_ - Note: Control ports are read from torrc files first, then these env vars as fallback
export APP_ELTOR_TOR_RELAY_CONTROL_PASSWORD="password1234_"
